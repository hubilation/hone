...
| **Config file** | Hone.xcodeproj (Xcode project) |
| **Quick run command** | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` |
| **Full suite command** | `xcodebuild test -scheme "Hone" -sdk iphonesimulator -destination 'platform=iOS Simulator,name=iPhone 15'` |
...
- **After every task commit:** Run `xcodebuild -scheme "Hone" -sdk iphonesimulator build`
...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 04-01-01 | 01 | 1 | Infrastructure | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-01-02 | 01 | 1 | Infrastructure | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-01-03 | 01 | 1 | Infrastructure | syntax | `python3 -c "import json; json.load(open('firestore.indexes.json'))"` | ✅ | ✅ green |
| 04-02-01 | 02 | 2 | POST-03 (partial) | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-02-02 | 02 | 2 | POST-03 (partial) | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-02-03 | 02 | 2 | POST-03 (partial) | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-03-01 | 03 | 2 | Infrastructure | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-03-02 | 03 | 2 | Infrastructure | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-03-03 | 03 | 2 | Infrastructure | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
| 04-04-01 | 04 | 3 | POST-03/04/06 | build | `xcodebuild -scheme "Hone" -sdk iphonesimulator build` | ✅ | ✅ green |
...
- [ ] `Hone Tests/SessionHistoryViewModelTests.swift` — stubs for POST-03, POST-04, POST-06
- [ ] `Hone Tests/MockSessionRepository.swift` — test doubles for SessionRepository
